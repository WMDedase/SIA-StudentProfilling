...
Route::middleware('auth:sanctum')->get('/user', function (Request $request) {
   ...
   $user->studentProfile->load('adviser');
   return $user;

});

// Route::middleware('auth:sanctum')->get('/borrowstatus/user', function (Request $request) {
//     $user = $request->user();
//     $studentId = $user->studentProfile->id; // Assuming student profile has an id field
//     $borrowStatus = BorrowedBook::where('student_id', $studentId)->get();
//     return response()->json($borrowStatus);
// });
