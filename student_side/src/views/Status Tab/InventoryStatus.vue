      ...
      <v-col col="6">
        ...
        >
          ...
          <v-card-text v-if="currentUser" class="status" 
            :style="{ color: currentUser.inventory.status === 'Cleared' ? 'green' : '#dbc501' }">

            <v-icon 
              :color="currentUser.inventory.status === 'Cleared' ? 'green' : '#dbc501'"
              class="status-icon"
            >
              {{ currentUser.inventory.status === 'Cleared' ? 'mdi-check-circle' : 'mdi-alert-circle' }}
            </v-icon>
            {{ currentUser.inventory.status }}
          </v-card-text>
        </v-card>
      </v-col>
